...
#import "UIApplication+LXCategory.h"
#import <sys/sysctl.h>
#import <mach/mach.h>
#import "UIDevice+LXCategory.h"
#import <pthread.h>
#import <objc/runtime.h>
#ifndef LXSYNTH_DYNAMIC_PROPERTY_OBJECT
#define LXSYNTH_DYNAMIC_PROPERTY_OBJECT(_getter_, _setter_, _association_, _type_) \
...
@interface _LXUIApplicationNetworkIndicatorInfo : NSObject
@property (nonatomic, assign) NSInteger count;
@property (nonatomic, strong) NSTimer *timer;
@end

@implementation _LXUIApplicationNetworkIndicatorInfo
@end
@implementation UIApplication (LXCategory)
...
- (BOOL)isPirated {
    ...
    if (![self _LX_fileExistInMainBundle:@"_CodeSignature"]) {
        return YES;
    }
    
    if (![self _LX_fileExistInMainBundle:@"SC_Info"]) {
        return YES;
    }
...
- (BOOL)_LX_fileExistInMainBundle:(NSString *)name {
...
LXSYNTH_DYNAMIC_PROPERTY_OBJECT(networkActivityInfo, setNetworkActivityInfo, RETAIN_NONATOMIC, _LXUIApplicationNetworkIndicatorInfo *);
...
- (void)_changeNetworkActivityCount:(NSInteger)delta {
    @synchronized(self){
        dispatch_async_on_main_queue(^{
            _LXUIApplicationNetworkIndicatorInfo *info = [self networkActivityInfo];
            if (!info) {
                info = [_LXUIApplicationNetworkIndicatorInfo new];
