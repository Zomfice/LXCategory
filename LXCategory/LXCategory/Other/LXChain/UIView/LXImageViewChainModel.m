...
#define LXCATEGORY_CHAIN_IMAGEVIEW_IMPLEMENTATION(LXMethod,LXParaType) LXCATEGORY_CHAIN_VIEWCLASS_IMPLEMENTATION(LXMethod,LXParaType, LXImageViewChainModel *,UIImageView)
...
@end
LXCATEGORY_VIEW_IMPLEMENTATION(UIImageView, LXImageViewChainModel)
#undef LXCATEGORY_CHAIN_IMAGEVIEW_IMPLEMENTATION
