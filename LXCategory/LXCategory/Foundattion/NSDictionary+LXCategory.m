...
#import "NSDictionary+LXCategory.h"
#import "NSData+LXCategory.h"
#import "NSString+LXCategory.h"
@implementation NSDictionary (LXCategory)
...
#pragma mark - xml解析 -
@interface LXXMLDictionaryParser : NSObject <NSXMLParserDelegate>{
...
@implementation LXXMLDictionaryParser
...
+ (NSDictionary *)dictionaryWithXML:(id)xmlDataOrString{
    LXXMLDictionaryParser *parser = nil;
    if ([xmlDataOrString isKindOfClass:[NSString class]]) {
        parser = [[LXXMLDictionaryParser alloc] initWithString:xmlDataOrString];
    } else if ([xmlDataOrString isKindOfClass:[NSData class]]) {
        parser = [[LXXMLDictionaryParser alloc] initWithData:xmlDataOrString];
    }
...
@end
@implementation NSMutableDictionary (LXCategory)
