...
#define LXCATEGORY_CHAIN_TABLEVIEW_IMPLEMENTATION(LXMethod,LXParaType) LXCATEGORY_CHAIN_IMPLEMENTATION(LXMethod,LXParaType, LXCollectionViewChainModel *,UICollectionView)
@implementation LXCollectionViewChainModel
LXSCROLLVIEWSUPERCHAINMODEL_IMPLEMENTATION(LXCollectionViewChainModel)

LXCATEGORY_CHAIN_TABLEVIEW_IMPLEMENTATION(collectionViewLayout, UICollectionViewLayout *)
LXCATEGORY_CHAIN_TABLEVIEW_IMPLEMENTATION(delegate, id<UICollectionViewDelegate>)
LXCATEGORY_CHAIN_TABLEVIEW_IMPLEMENTATION(dataSource, id<UICollectionViewDataSource>)
